' ********************************************************************
' ********************************************************************
' **  Roku NPO Nederland 2 Channel (BrightScript)
' **
' **  Dec 2013
...
Sub Setup() As Object
    ...
    jsonRequest.SetURL("http://ida.omroep.nl/aapi/?stream=http://livestreams.omroep.nl/live/npo/tvlive/ned2/ned2.isml/ned2.m3u8")
